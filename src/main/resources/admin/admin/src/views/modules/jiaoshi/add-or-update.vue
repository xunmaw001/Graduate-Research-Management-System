               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工作时长" prop="jiaoshiShichang">
                       <el-input v-model="ruleForm.jiaoshiShichang"
                                 placeholder="工作时长" clearable  :readonly="ro.jiaoshiShichang"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="教师简介" prop="jiaoshiContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiaoshiContent" label="教师简介" prop="jiaoshiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaoshiContent: [
                              { required: true, message: '教师简介不能为空', trigger: 'blur' },
                          ],
                   jiaoshiDelete: [
